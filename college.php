...
// Fetch programs from the database where the category is 'college'
$sql = "SELECT * FROM programs WHERE category = 'college' ORDER BY program_id DESC";
...
<body>
    ...
    <section class="hero">
        <div class="container">
            <h1>Explore the College Programs of <br> Lyceum of Subic Bay</h1>
            <p>Discover a range of academic programs at LSB, designed to equip students with the knowledge and skills needed to succeed in their chosen fields. Whether you're interested in technology, business, or the arts, LSB offers a diverse selection of courses to shape your future!</p>
            <a href="#programs" class="btn btn-primary">Explore College Programs</a>
        </div>
    </section>
    ...
    <div class="container my-5">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text">
                    The <strong>College programs</strong> at Lyceum of Subic Bay are designed to provide a comprehensive education, preparing students for successful careers in various fields.
                </p>
            </div>
        </div>
