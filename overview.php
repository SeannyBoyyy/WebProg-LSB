...
// Fetch programs categorized by Senior High and College
$sql_senior_high = "SELECT * FROM programs WHERE category = 'Senior High' ORDER BY program_id DESC LIMIT 3";
$sql_college = "SELECT * FROM programs WHERE category = 'College' ORDER BY program_id DESC LIMIT 3";

$result_senior_high = $conn->query($sql_senior_high);
...
<body>
    ...
    <section class="hero">
        <div class="container">
            <h1>Explore the Programs of <br> Lyceum of Subic Bay</h1>
            <p>Discover a variety of academic and extracurricular programs at LSB that empower students to excel both in the classroom and beyond. From cutting-edge courses to engaging student activities, there's something for everyone!</p>
